...
export declare class FakeAdapter extends PlatformAdapter<any> {
    ...
    mapHandler(handler: PlatformContextHandler<PlatformContext>): PlatformContextHandler<PlatformContext<import("./PlatformRequest.js").PlatformRequest<any>, import("./PlatformResponse.js").PlatformResponse<any>>>;
    useContext(): void;
}
