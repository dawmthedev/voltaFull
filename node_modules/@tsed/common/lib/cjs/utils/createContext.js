...
function createContext(injector) {
    const ResponseKlass = injector.getProvider(PlatformResponse_js_1.PlatformResponse)?.useClass;
    const RequestKlass = injector.getProvider(PlatformRequest_js_1.PlatformRequest)?.useClass;
