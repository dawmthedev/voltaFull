...
const AnyToPromiseWithCtx_js_1 = require("../domain/AnyToPromiseWithCtx.js");
const setResponseHeaders_js_1 = require("../utils/setResponseHeaders.js");
const PlatformApplication_js_1 = require("./PlatformApplication.js");
const PlatformMiddlewaresChain_js_1 = require("./PlatformMiddlewaresChain.js");
/**
...
let PlatformHandler = class PlatformHandler {
    ...
    async onRequest(handler, $ctx) {
        ...
        const resolver = new AnyToPromiseWithCtx_js_1.AnyToPromiseWithCtx($ctx);
    ...
    onResponse({ status, data, headers }, $ctx) {
        ...
        if ($ctx.handlerMetadata.isEndpoint()) {
            (0, setResponseHeaders_js_1.setResponseHeaders)($ctx);
        }
    }
    /**
...
tslib_1.__decorate([
    (0, di_1.Inject)(),
    tslib_1.__metadata("design:type", PlatformApplication_js_1.PlatformApplication)
], PlatformHandler.prototype, "platformApplication", void 0);
tslib_1.__decorate([
    (0, di_1.Inject)(),
    tslib_1.__metadata("design:type", PlatformMiddlewaresChain_js_1.PlatformMiddlewaresChain)
