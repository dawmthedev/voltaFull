...
const PlatformAcceptMimesMiddleware_js_1 = require("../middlewares/PlatformAcceptMimesMiddleware.js");
const PlatformMulterMiddleware_js_1 = require("../middlewares/PlatformMulterMiddleware.js");
...
let PlatformMiddlewaresChain = class PlatformMiddlewaresChain {
    get(handlers, operationRoute) {
        ...
        return {
            ...handlers,
            before: [ACCEPT_MIMES && PlatformAcceptMimesMiddleware_js_1.PlatformAcceptMimesMiddleware, ...handlers.before, FILE && PlatformMulterMiddleware_js_1.PlatformMulterMiddleware].filter(Boolean)
        };
    }
...
tslib_1.__decorate([
    (0, di_1.Inject)(PlatformAdapter_js_1.PlatformAdapter),
    tslib_1.__metadata("design:type", PlatformAdapter_js_1.PlatformAdapter)
