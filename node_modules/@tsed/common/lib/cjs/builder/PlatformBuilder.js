...
const closeServer_js_1 = require("../utils/closeServer.js");
const createInjector_js_1 = require("../utils/createInjector.js");
const getConfiguration_js_1 = require("../utils/getConfiguration.js");
const getStaticsOptions_js_1 = require("../utils/getStaticsOptions.js");
const printRoutes_js_1 = require("../utils/printRoutes.js");
/**
 * @platform
 */
class PlatformBuilder {
    ...
    constructor(adapter, module, settings) {
        ...
        const configuration = (0, getConfiguration_js_1.getConfiguration)(settings, module);
        ...
        this.#injector = (0, createInjector_js_1.createInjector)({
            adapter: adapterKlass,
            settings: configuration
        });
        this.log(`Loading ${adapterKlass.NAME.toUpperCase()} platform adapter...`);
        this.#adapter = this.#injector.get(PlatformAdapter_js_1.PlatformAdapter);
    ...
    get platform() {
        return this.injector.get(Platform_js_1.Platform);
    }
    get adapter() {
        return this.#adapter;
    }
    ...
    async stop() {
        ...
        this.#listeners.map(closeServer_js_1.closeServer);
    }
    async ready() {
    ...
    loadStatics(hook) {
        ...
        (0, getStaticsOptions_js_1.getStaticsOptions)(statics).forEach(({ path, options }) => {
    ...
    async logRoutes(layers) {
        ...
        if (!this.settings.get("logger.disableRoutesSummary") && !this.disableBootstrapLog) {
            ...
            logger.info((0, printRoutes_js_1.printRoutes)(await this.injector.alterAsync("$logRoutes", routes)));
        }
    }
