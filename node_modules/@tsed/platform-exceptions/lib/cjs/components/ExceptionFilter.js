...
const catch_js_1 = require("../decorators/catch.js");
const ErrorFilter_js_1 = require("./ErrorFilter.js");
let ExceptionFilter = class ExceptionFilter extends ErrorFilter_js_1.ErrorFilter {
    catch(error, ctx) {
...
ExceptionFilter = tslib_1.__decorate([
    (0, catch_js_1.Catch)(exceptions_1.Exception)
], ExceptionFilter);
