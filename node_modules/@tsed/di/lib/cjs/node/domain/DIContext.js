...
const asyncHookContext_js_1 = require("../utils/asyncHookContext.js");
const ContextLogger_js_1 = require("./ContextLogger.js");
class DIContext {
    #container;
    #cache;
    #logger;
     ...
     */
    get logger() {
        this.#logger = this.#logger || new ContextLogger_js_1.ContextLogger(this.opts);
        return this.#logger;
    }
    /**
     ...
     */
    get container() {
        return (this.#container = this.#container || new index_js_1.LocalsContainer());
    }
    destroy() {
    ...
    runInContext(next) {
        return (0, asyncHookContext_js_1.runInContext)(this, next);
    }
    cache(key, cb) {
        if (!this.has(key)) {
            this.set(key, cb());
