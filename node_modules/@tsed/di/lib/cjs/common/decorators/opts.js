...
function Opts(target, propertyKey, index) {
    (0, scope_js_1.Scope)(ProviderScope_js_1.ProviderScope.INSTANCE)((0, core_1.classOf)(target));
    (0, inject_js_1.Inject)(constants_js_1.DI_PARAM_OPTIONS)(target, propertyKey, index);
}
exports.Opts = Opts;
