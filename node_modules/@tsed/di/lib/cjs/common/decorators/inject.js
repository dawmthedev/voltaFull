...
const InvalidPropertyTokenError_js_1 = require("../errors/InvalidPropertyTokenError.js");
...
function injectProperty(target, propertyKey, options) {
    core_1.Store.from(target).merge(constants_js_1.INJECTABLE_PROP, {
        [propertyKey]: {
    ...
    return (target, propertyKey, descriptor) => {
        ...
        switch (bindingType) {
            case core_1.DecoratorTypes.PARAM_CTOR:
                if (token) {
                    const paramTypes = (0, getConstructorDependencies_js_1.getConstructorDependencies)(target, propertyKey);
                    ...
                    (0, getConstructorDependencies_js_1.setConstructorDependencies)(target, paramTypes);
                }
                break;
            case core_1.DecoratorTypes.PROP:
                const useType = token || core_1.Metadata.getType(target, propertyKey);
                if (useType === Object) {
                    throw new InvalidPropertyTokenError_js_1.InvalidPropertyTokenError(target, String(propertyKey));
                }
                    ...
                    resolver(injector, locals, { options, ...invokeOptions }) {
                        ...
                        if (originalType === Array) {
                            ...
                            if (!bean) {
                                ...
                                locals.delete(constants_js_1.DI_PARAM_OPTIONS);
                            }
