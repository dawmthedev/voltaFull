...
const ProviderScope_js_1 = require("./ProviderScope.js");
...
class Provider {
    constructor(token, options = {}) {
         ...
         */
        this.type = ProviderType_js_1.ProviderType.PROVIDER;
        this.provide = token;
        this.useClass = token;
    ...
    get scope() {
        if (this.isAsync()) {
            return ProviderScope_js_1.ProviderScope.SINGLETON;
        }
