 ...
 */
export declare function registerProvider<Type = any>(provider: Partial<ProviderOpts<Type>>): Provider<any>;
/**
 ...
 * ```
 */
export declare const registerValue: (provider: any | ProviderOpts<any>, value?: any) => void;
/**
