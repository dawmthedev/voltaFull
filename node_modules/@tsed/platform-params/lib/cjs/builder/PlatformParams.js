...
const ParamValidationError_js_1 = require("../errors/ParamValidationError.js");
const ParseExpressionPipe_js_1 = require("../pipes/ParseExpressionPipe.js");
/**
...
let PlatformParams = class PlatformParams {
    getPipes(param) {
        ...
        return [ParseExpressionPipe_js_1.ParseExpressionPipe, ...param.pipes.sort(sort)].map(map).filter(Boolean);
    }
    /**
    ...
    getArg(scope, pipes, param) {
        return pipes.reduce(async (value, pipe) => {
            ...
            try {
                ...
                throw ParamValidationError_js_1.ParamValidationError.from(param, er);
            }
        }, scope);
    }
};
...
PlatformParams = tslib_1.__decorate([
    (0, di_1.Injectable)({
        ...
        imports: [ParseExpressionPipe_js_1.ParseExpressionPipe]
    })
], PlatformParams);
