...
let ParseExpressionPipe = class ParseExpressionPipe {
    transform(scope, param) {
        ...
        if ([ParamTypes_js_1.ParamTypes.QUERY, ParamTypes_js_1.ParamTypes.PATH].includes(paramType) && value === "" && type !== String) {
            return undefined;
        }
        return value;
    }
    getKey(param) {
        ...
        if (expression && paramType === ParamTypes_js_1.ParamTypes.HEADER) {
