...
let JsonPropertyStore = class JsonPropertyStore extends JsonEntityStore_js_1.JsonEntityStore {
    ...
    build() {
        ...
        if (!schema) {
            ...
            schema = JsonSchema_js_1.JsonSchema.from({
    ...
    static get(target, propertyKey) {
        return JsonEntityStore_js_1.JsonEntityStore.from((0, core_1.prototypeOf)(target), propertyKey);
    }
};
JsonPropertyStore = tslib_1.__decorate([
    (0, jsonEntityComponent_js_1.JsonEntityComponent)(core_1.DecoratorTypes.PROP)
], JsonPropertyStore);
