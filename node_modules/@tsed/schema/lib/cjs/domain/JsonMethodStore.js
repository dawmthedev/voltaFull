...
const JsonOperation_js_1 = require("./JsonOperation.js");
...
let JsonMethodStore = class JsonMethodStore extends JsonEntityStore_js_1.JsonEntityStore {
    ...
    static get(target, propertyKey, descriptor) {
        ...
        return JsonEntityStore_js_1.JsonEntityStore.from((0, core_1.prototypeOf)(target), propertyKey, descriptor);
    }
...
JsonMethodStore = tslib_1.__decorate([
    (0, jsonEntityComponent_js_1.JsonEntityComponent)(core_1.DecoratorTypes.METHOD),
