...
const httpStatusMessages_js_1 = require("../../constants/httpStatusMessages.js");
const DecoratorContext_js_1 = require("../../domain/DecoratorContext.js");
const JsonEntityStore_js_1 = require("../../domain/JsonEntityStore.js");
const JsonParameter_js_1 = require("../../domain/JsonParameter.js");
const JsonSchema_js_1 = require("../../domain/JsonSchema.js");
const string_js_1 = require("../../fn/string.js");
const defineStatusModel_js_1 = require("../../utils/defineStatusModel.js");
const isSuccessStatus_js_1 = require("../../utils/isSuccessStatus.js");
...
function mapGenerics(types) {
    return types.map((type) => {
        if (isEnum(type)) {
            return (0, string_js_1.string)().enum(Object.values(type));
        }
        return type;
    });
}
...
class ReturnDecoratorContext extends DecoratorContext_js_1.DecoratorContext {
    ...
    status(status) {
        ...
        if (status && (0, httpStatusMessages_js_1.getStatusMessage)(status) && !this.get("description")) {
            this.set("description", (0, httpStatusMessages_js_1.getStatusMessage)(status));
            if (!this.get("model")) {
                this.model((0, defineStatusModel_js_1.getStatusModel)(+status));
            }
        }
        return this;
    }
    headers(headers) {
        this.set("headers", {
            ...(this.get("headers") || {}),
            ...(0, mapHeaders_js_1.mapHeaders)(headers)
        });
        return this;
    }
    header(key, value) {
    ...
    getContentType() {
        ...
        if ((model && !(0, core_1.isPlainObject)(model) && !(0, core_1.isPrimitiveOrPrimitiveClass)(model)) || this.hasOfTypes) {
    ...
    onInit(args, decorator) {
        ...
        switch (type) {
            case core_1.DecoratorTypes.METHOD:
                this.entity = JsonEntityStore_js_1.JsonEntityStore.from(...args);
    ...
    map() {
        ...
        if ((0, isSuccessStatus_js_1.isSuccessStatus)(this.get("status")) || currentStatus === "default") {
            if (model) {
                entity.type = model;
            }
        }
    ...
    mapMedia(response) {
        ...
        const schema = media.get("schema") || new JsonSchema_js_1.JsonSchema({ type: model });
        ...
        if (allowedGroups) {
            ...
            const jsonParameter = new JsonParameter_js_1.JsonParameter();
            jsonParameter.in("query").name("includes");
            jsonParameter.schema(JsonSchema_js_1.JsonSchema.from({
                type: "array",
                items: {
                    type: "string",
                    enum: [...allowedGroups]
