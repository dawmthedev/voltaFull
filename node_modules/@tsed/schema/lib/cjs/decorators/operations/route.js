...
function All(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.ALL, path].concat(args));
}
exports.All = All;
/**
 * This method is just like the `router.METHOD()` methods, except that it matches all HTTP methods (verbs).
...
function Get(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.GET, path].concat(args));
}
exports.Get = Get;
/**
 * This method is just like the `router.METHOD()` methods, except that it matches all HTTP methods (verbs).
...
function Post(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.POST, path].concat(args));
}
exports.Post = Post;
/**
 * This method is just like the `router.METHOD()` methods, except that it matches all HTTP methods (verbs).
...
function Put(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.PUT, path].concat(args));
}
exports.Put = Put;
/**
 * This method is just like the `router.METHOD()` methods, except that it matches all HTTP methods (verbs).
...
function Delete(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.DELETE, path].concat(args));
}
...
function Head(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.HEAD, path].concat(args));
}
exports.Head = Head;
/**
 * This method is just like the `router.METHOD()` methods, except that it matches all HTTP methods (verbs).
...
function Patch(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.PATCH, path].concat(args));
}
exports.Patch = Patch;
/**
 * This method is just like the `router.METHOD()` methods, except that it matches all HTTP methods (verbs).
...
function Options(path = "/", ...args) {
    return (0, operation_js_1.Operation)(...[OperationVerbs_js_1.OperationVerbs.OPTIONS, path].concat(args));
}
