...
const minimum_js_1 = require("./minimum.js");
/**
 ...
 * @ajv-errors
 */
exports.ExclusiveMinimum = (0, withErrorMsg_js_1.withErrorMsg)("exclusiveMinimum", (minimum, exclusiveMinimum = true) => {
    return (0, minimum_js_1.Minimum)(minimum, exclusiveMinimum);
});
