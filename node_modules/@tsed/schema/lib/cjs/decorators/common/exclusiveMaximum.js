...
const maximum_js_1 = require("./maximum.js");
/**
 ...
 * @ajv-errors
 */
exports.ExclusiveMaximum = (0, withErrorMsg_js_1.withErrorMsg)("exclusiveMaximum", (maximum, exclusiveMaximum = true) => {
    return (0, maximum_js_1.Maximum)(maximum, exclusiveMaximum);
});
