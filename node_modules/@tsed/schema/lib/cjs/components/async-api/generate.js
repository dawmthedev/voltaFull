...
function generate(model, options) {
    const specJson = {
        channels: (0, JsonSchemaMapperContainer_js_1.execMapper)("channels", [model], options)
    };
...
(0, JsonSchemaMapperContainer_js_1.registerJsonSchemaMapper)("generate", generate, SpecTypes_js_1.SpecTypes.ASYNCAPI);
