...
function inlineReference(parameter, { jsonParameter, ...options }) {
    const name = (0, ref_js_1.createRefName)(jsonParameter.$schema.getName(), options);
...
(0, JsonSchemaMapperContainer_js_1.registerJsonSchemaMapper)("operationInQuery", operationInQueryMapper);
