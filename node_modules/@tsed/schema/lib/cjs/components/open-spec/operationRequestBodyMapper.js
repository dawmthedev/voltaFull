...
const JsonRequestBody_js_1 = require("../../domain/JsonRequestBody.js");
...
function buildSchemaFromBodyParameters(parameters, options) {
    let schema = new JsonSchema_js_1.JsonSchema();
    const props = {};
    const refs = [];
    let propsLength = 0;
    ...
    parameters.forEach((parameter) => {
        ...
        const jsonParameter = (0, JsonSchemaMapperContainer_js_1.execMapper)("operationInParameter", [parameter], options);
        if (name) {
            const propSchema = {
...
function operationRequestBodyMapper(bodyParameters, { consumes, ...options }) {
    ...
    const requestBody = new JsonRequestBody_js_1.JsonRequestBody(props);
    consumes.forEach((consume) => {
        requestBody.addContent(consume, schema, examples);
    });
    return (0, JsonSchemaMapperContainer_js_1.execMapper)("map", [requestBody], options);
}
exports.operationRequestBodyMapper = operationRequestBodyMapper;
(0, JsonSchemaMapperContainer_js_1.registerJsonSchemaMapper)("operationRequestBody", operationRequestBodyMapper);
