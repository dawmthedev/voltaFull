 ...
 * @input
 */
export declare function Schema(partialSchema: Partial<JsonSchemaObject> | JsonSchema): (...args: any[]) => any;
/**
 ...
 * @input
 */
export declare function For(specType: SpecTypes, schema: any): (...args: any[]) => any;
