 ...
 * @operation
 */
export declare function Operation(method: string, path: string, ...args: any[]): RouteChainedDecorators;
export declare function Operation(...args: any[]): RouteChainedDecorators;
