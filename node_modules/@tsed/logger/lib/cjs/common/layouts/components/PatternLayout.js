...
let PatternLayout = class PatternLayout extends BaseLayout_1.BaseLayout {
    ...
    constructor(config) {
        ...
        this.#replacers = new PatternLayout_1.LayoutReplacer(this.#tokens, this.config.timezoneOffset).build();
    }
    /**
     *
     * @param loggingEvent
...
exports.PatternLayout = PatternLayout = PatternLayout_1 = tslib_1.__decorate([
