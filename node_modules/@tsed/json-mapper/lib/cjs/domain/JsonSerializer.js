...
const alterOnSerialize_js_1 = require("../hooks/alterOnSerialize.js");
const getObjectProperties_js_1 = require("../utils/getObjectProperties.js");
...
class JsonSerializer extends JsonMapperCompiler_js_1.JsonMapperCompiler {
    constructor() {
        super();
    ...
    alterValue(schemaId, value, options) {
        return (0, alterOnSerialize_js_1.alterOnSerialize)(this.schemes[schemaId], value, options);
    }
    ...
    mapPrecondition(id) {
        ...
        writer.if("input && isCollection(input)").return(Writer_js_1.Writer.mapperFrom("input", `{...options, id: '${id}'}`));
    ...
    mapObject(input, { type, ...options }) {
        ...
        return (0, getObjectProperties_js_1.getObjectProperties)(input)
