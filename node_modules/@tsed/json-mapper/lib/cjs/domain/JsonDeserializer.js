...
const alterAfterDeserialize_js_1 = require("../hooks/alterAfterDeserialize.js");
const alterBeforeDeserialize_js_1 = require("../hooks/alterBeforeDeserialize.js");
const alterOnDeserialize_js_1 = require("../hooks/alterOnDeserialize.js");
const JsonMapperCompiler_js_1 = require("./JsonMapperCompiler.js");
const JsonMapperSettings_js_1 = require("./JsonMapperSettings.js");
const JsonMapperTypesContainer_js_1 = require("./JsonMapperTypesContainer.js");
...
class JsonDeserializer extends JsonMapperCompiler_js_1.JsonMapperCompiler {
    constructor() {
        super();
        /**
    ...
    createMapper(model, id, groups) {
        ...
        const writer = new Writer_js_1.Writer().arrow("input", "options");
    ...
    alterValue(schemaId, value, options) {
        return (0, alterOnDeserialize_js_1.alterOnDeserialize)(this.schemes[schemaId], value, options);
    }
    ...
    mapProperty(propertyStore, id, groups) {
        ...
        let writer = new Writer_js_1.Writer().add(`// Map ${key} ${id} ${groups || ""}`);
        ...
        if (hasDeserializer) {
            this.schemes[schemaId] = propertyStore.schema;
            const opts = Writer_js_1.Writer.options(formatOpts);
    ...
    getPropertyFiller(propertyStore, id, groups, formatOpts) {
        ...
        if (isGeneric) {
            ...
            const opts = Writer_js_1.Writer.options(formatOpts, `type: generics[${index}]`);
    ...
    mapOptions({ groups, useAlias = true, types, ...options }) {
        ...
        const customMappers = {};
        types = types || (0, JsonMapperTypesContainer_js_1.getJsonMapperTypes)();
        ...
        const strictGroups = options.strictGroups ?? JsonMapperSettings_js_1.JsonMapperSettings.strictGroups;
        return {
            ...options,
            additionalProperties: options.additionalProperties ?? JsonMapperSettings_js_1.JsonMapperSettings.additionalProperties,
            disableUnsecureConstructor: options.disableUnsecureConstructor ?? JsonMapperSettings_js_1.JsonMapperSettings.disableUnsecureConstructor,
    ...
    mapAdditionalProperties(entity, properties, groups) {
        ...
        if ((0, core_1.isClass)(additionalProperties)) {
            ...
            each.set("obj[key]", Writer_js_1.Writer.mapper(nestedMapper.id, "input[key]", "options"));
            return writer;
        }
    ...
    alterBeforeDeserialize(schemaId, value, options) {
        return (0, alterBeforeDeserialize_js_1.alterBeforeDeserialize)(value, this.schemes[schemaId], options);
    }
    alterAfterDeserialize(schemaId, value, options) {
        return (0, alterAfterDeserialize_js_1.alterAfterDeserialize)(value, this.schemes[schemaId], options);
    }
}
