...
const AjvValidationError_js_1 = require("../errors/AjvValidationError.js");
const defaultErrorFormatter_js_1 = require("../utils/defaultErrorFormatter.js");
...
let AjvService = class AjvService {
    async validate(value, options) {
        ...
        if (schema) {
            const localValue = this.returnsCoercedValues ? value : (0, core_1.deepClone)(value);
    ...
    mapErrors(errors, options) {
        ...
        const message = errors
            ...
            const dataPath = (0, getPath_js_1.getPath)(error);
            if (!error.data) {
                if (dataPath) {
            ...
            .join("\n");
        return new AjvValidationError_js_1.AjvValidationError(message, errors);
    }
...
tslib_1.__decorate([
    (0, di_1.Constant)("ajv.errorFormatter", defaultErrorFormatter_js_1.defaultErrorFormatter),
    tslib_1.__metadata("design:type", Function)
], AjvService.prototype, "errorFormatter", void 0);
tslib_1.__decorate([
    (0, di_1.Constant)("ajv.returnsCoercedValues"),
    tslib_1.__metadata("design:type", Boolean)
], AjvService.prototype, "returnsCoercedValues", void 0);
tslib_1.__decorate([
    (0, di_1.Inject)(),
