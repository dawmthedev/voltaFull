...
class Engine {
    ...
    get engine() {
        return (0, cache_js_1.getCachedEngine)(this.name);
    }
    async $onInit() {
    ...
    compile(template, options) {
        ...
        return (0, cache_js_1.cache)(options) || (0, cache_js_1.cache)(options, this.$compile.call(this, template, options));
    }
    compileFile(file, options) {
        options = this.$cacheOptions(file, options, true);
        return (0, cache_js_1.cache)(options) || (0, cache_js_1.cache)(options, this.$compileFile.call(this, file, options));
    }
    ...
    async readPartials(file, options) {
        ...
        const partials = await (0, cache_js_1.readPartials)(file, options);
    ...
    async $compileFile(file, options) {
        const template = await (0, cache_js_1.read)(file, options);
    ...
    async importEngine(name, options) {
        ...
        for (const req of reqs) {
            try {
                await (0, cache_js_1.importEngine)(req, name);
                this.driverName = req;
            }
            catch (er) { }
        }
