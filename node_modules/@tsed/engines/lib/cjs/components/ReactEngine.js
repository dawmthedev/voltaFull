...
let ReactEngine = class ReactEngine extends Engine_js_1.Engine {
    ...
    async $onInit() {
        await super.$onInit();
        await (0, cache_js_1.importEngine)("react-dom/server", "ReactDOM");
        await (0, cache_js_1.importEngine)("@babel/core", "babel");
    }
    get babel() {
        return (0, cache_js_1.getCachedEngine)("babel");
    }
    get reactDOM() {
        return (0, cache_js_1.getCachedEngine)("ReactDOM");
    }
    patchRequire() {
    ...
    renderWithBase(key, base, enableCache, options) {
        const baseStr = (0, cache_js_1.getFromCache)(key) || (0, fs_1.readFileSync)((0, path_1.resolve)(base), "utf8");
        if (enableCache) {
            (0, cache_js_1.setToCache)(key, baseStr);
        }
...
ReactEngine = tslib_1.__decorate([
    (0, viewEngine_js_1.ViewEngine)("react", {
        requires: ["react"]
    }),
