...
const authOptions_js_1 = require("./authOptions.js");
const useBefore_js_1 = require("./useBefore.js");
/**
            ...
            case core_1.DecoratorTypes.METHOD:
                return (0, core_1.useDecorators)((0, core_1.StoreFn)((store) => {
                    if (!store.has(guardAuth)) {
                        return (0, useBefore_js_1.UseBefore)(guardAuth);
                    }
                }), (0, authOptions_js_1.AuthOptions)(guardAuth, options))(...args);
