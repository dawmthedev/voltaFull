...
const ResponseFiltersContainer_js_1 = require("../domain/ResponseFiltersContainer.js");
const getContentType_js_1 = require("../utils/getContentType.js");
const renderView_js_1 = require("../utils/renderView.js");
/**
 * @platform
 */
let PlatformResponseFilter = class PlatformResponseFilter {
    ...
    $onInit() {
        ResponseFiltersContainer_js_1.ResponseFiltersContainer.forEach((token, type) => {
    ...
    getBestContentType(data, ctx) {
        const contentType = (0, getContentType_js_1.getContentType)(data, ctx);
    ...
    transform(data, ctx) {
        ...
        if (ctx.endpoint?.operation) {
            ...
            if (this.types.has(getContentType_js_1.ANY_CONTENT_TYPE)) {
                return this.types.get(getContentType_js_1.ANY_CONTENT_TYPE).transform(data, ctx);
            }
        }
        return data;
    }
    ...
    async serialize(data, ctx) {
        ...
        if (endpoint) {
            if (endpoint.view) {
                data = await (0, renderView_js_1.renderView)(data, ctx);
            }
