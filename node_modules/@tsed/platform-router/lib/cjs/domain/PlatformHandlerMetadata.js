...
const PlatformHandlerType_js_1 = require("./PlatformHandlerType.js");
class PlatformHandlerMetadata {
    #handler;
    constructor(props) {
        this.type = PlatformHandlerType_js_1.PlatformHandlerType.RAW_FN;
        this.hasNextFunction = false;
        this.opts = {};
        const { propertyKey, type, provider, handler, opts } = props;
        this.provider = provider;
        this.type = type || handler.type || PlatformHandlerType_js_1.PlatformHandlerType.RAW_FN;
        this.opts = opts || {};
        ...
        if (propertyKey) {
            ...
            if (this.hasParamType(platform_params_1.ParamTypes.ERR)) {
                this.type = PlatformHandlerType_js_1.PlatformHandlerType.ERR_MIDDLEWARE;
            }
        }
        else {
            if (this.#handler.length === 4) {
                this.type = PlatformHandlerType_js_1.PlatformHandlerType.RAW_ERR_FN;
            }
    ...
    get hasErrorParam() {
        return this.type === PlatformHandlerType_js_1.PlatformHandlerType.ERR_MIDDLEWARE || this.type === PlatformHandlerType_js_1.PlatformHandlerType.RAW_ERR_FN;
    }
    get store() {
    ...
    static from(injector, input, opts = {}) {
        ...
        if (input instanceof schema_1.EndpointMetadata) {
            ...
            return new PlatformHandlerMetadata({
                provider,
                type: PlatformHandlerType_js_1.PlatformHandlerType.ENDPOINT,
        ...
        if (provider) {
            return new PlatformHandlerMetadata({
                provider,
                type: PlatformHandlerType_js_1.PlatformHandlerType.MIDDLEWARE,
                propertyKey: "use",
                opts
            });
        }
    ...
    isRawFn() {
        return this.type === PlatformHandlerType_js_1.PlatformHandlerType.RAW_ERR_FN || this.type === PlatformHandlerType_js_1.PlatformHandlerType.RAW_FN;
    }
    isEndpoint() {
        return this.type === PlatformHandlerType_js_1.PlatformHandlerType.ENDPOINT;
    }
    isCtxFn() {
        return this.type === PlatformHandlerType_js_1.PlatformHandlerType.CTX_FN;
    }
    isResponseFn() {
        return this.type === PlatformHandlerType_js_1.PlatformHandlerType.RESPONSE_FN;
    }
    toString() {
