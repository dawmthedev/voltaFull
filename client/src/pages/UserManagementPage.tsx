...
const UserManagementPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full px-4 md:px-6 bg-gray-50 dark:bg-gray-800 overflow-hidden">
      <div className="w-full max-w-screen-xl mx-auto flex flex-col h-full">
        ...
        {/* Updated DataTable container with scrolling */}
        <div className="flex-1 w-full max-w-screen-xl mx-auto px-4 md:px-6 bg-white dark:bg-gray-900 overflow-y-auto h-full">
          <DataTable
            columns={columns}
            data={users}
            page={page}
