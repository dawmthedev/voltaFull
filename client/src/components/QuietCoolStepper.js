...
const QuietCoolStepper = ({ activeStep, taskDates, financing }) => {
    ...
    return (
        <div>
            <Typography> Quiet Cool Milestones</Typography>
...
const style = {
    ...
    boxShadow: 24,
    p: 4,
export default QuietCoolStepper;
